...
class SearchResultPresenter:
    ...
    def _sort_results(
        ...
        if sort_order == SortOrder.RELEVANCE:
            ...
            return sorted(results, key=lambda r: r.metadata.get('modified_time', ''), reverse=True)
        elif sort_order == SortOrder.FILE_SIZE:
            return sorted(results, key=lambda r: r.metadata.get('file_size', 0), reverse=True)
    ...
    def _format_compact(self, result: SearchResult, options: PresentationOptions) -> str:
    ...
    def _format_detailed(self, result: SearchResult, options: PresentationOptions) -> str:
    ...
    def _format_summary(self, result: SearchResult, options: PresentationOptions) -> str:
    ...
    def _format_timeline(self, result: SearchResult, options: PresentationOptions) -> str:
