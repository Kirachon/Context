...
class QueryEnhancer:
    ...
    def _get_recent_context(self, recent_files: List[str], intent_result: QueryIntentResult) -> str:
    ...
    def _get_pattern_context(self, patterns: Dict[str, Any], intent_result: QueryIntentResult) -> str:
    ...
    def get_follow_up_questions(self, intent_result: QueryIntentResult) -> List[str]:
        ...
        if intent_result.intent == QueryIntent.SEARCH:
            ...
            questions.append("Would you like to see the full implementation or just the interface?")
            questions.append("Should I include related dependencies?")
        elif intent_result.intent == QueryIntent.REFACTOR:
            questions.append("What's your priority: readability, performance, or maintainability?")
