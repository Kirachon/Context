...
def register_cache_management_tools(mcp: FastMCP):
    ...
    async def cache_health_check() -> Dict[str, Any]:
        ...
        try:
            ...
            embedding_healthy = (
                ...
                and embedding_stats["hit_rate_percent"] > 20
                and embedding_stats["errors"] < 100
            )
    ...
    async def configure_cache(
        ttl_seconds: Optional[int] = None, max_cache_size: Optional[int] = None
    ) -> Dict[str, Any]:
        """
        ...
        """
        logger.info(
            f"MCP cache configuration invoked: ttl={ttl_seconds}, max_size={max_cache_size}"
        )
