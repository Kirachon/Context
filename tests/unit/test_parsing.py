...
from src.parsing.models import (
    Language, ParseResult, ASTNode, SymbolInfo, ClassInfo,
    ImportInfo, RelationshipInfo, ParameterInfo
)
from src.parsing.cache import ASTCache
from src.parsing.extractors import (
    SymbolExtractor, PythonExtractor, JavaScriptExtractor,
    TypeScriptExtractor, JavaExtractor, get_symbol_extractor
)
...
class TestASTNode:
    ...
    def test_ast_node_to_dict(self):
        ...
        parent = ASTNode("function_definition", "def test(): pass", 0, 16, (0, 0), (0, 16))
...
class TestASTCache:
    ...
    def test_cache_clear(self):
        ...
        self.mock_redis.delete.assert_called_once_with("ast_cache:file1", "ast_cache:file2")
...
class TestSymbolExtraction:
    ...
    def test_extractor_initialization(self):
        ...
        assert isinstance(self.extractor.language_extractors[Language.PYTHON], PythonExtractor)
    ...
    def test_python_function_extraction_mock(self):
        ...
        # Extract symbols
        symbols, classes, imports, relationships = self.extractor.extract_symbols(root_node, Language.PYTHON)
    ...
    def test_javascript_function_extraction_mock(self):
        ...
        # Extract symbols
        symbols, classes, imports, relationships = self.extractor.extract_symbols(root_node, Language.JAVASCRIPT)
