...
from src.analysis.cross_language import (
    CrossLanguageAnalyzer, PatternType, ArchitecturalLayer,
    DependencyRelation, PatternMatch, ArchitecturalAnalysis
)
...
class TestCrossLanguageAnalyzer:
    ...
    def test_architectural_layer_classification(self):
        ...
        test_cases = [
            (Path("src/controllers/user_controller.py"), ArchitecturalLayer.PRESENTATION),
    ...
    def test_complexity_metrics_calculation(self):
        ...
        metrics = self.analyzer._calculate_complexity_metrics([parse_result], dependencies)
    ...
    def test_language_distribution_analysis(self):
        ...
        parse_results = [
            ...
            ParseResult(Path("file3.js"), Language.JAVASCRIPT, None, parse_success=True),
        ]
